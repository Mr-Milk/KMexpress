kmplot_revised<-function(test_final,km_type){
require(survival)
data<-test_final
if (dim(data)[2]==3)
...
remove(a)
dev.off()
filename=paste(Expression,"_survival",".png",sep="")
