			...
			<tr>
				<td>
					<table width="100%" cellspacing="5" border="0">
						<tr>
							<td width="250" align="top" valign="top">
							...
							<td align="left" valign="top" width="250">
								<div id="yuanjiao4" <?php if ($database != "" and $genes != "") {
									...
									<table width="100%">
										<tr>
											<td align="left">
												<span style="color:#333;font-size:18px">&nbsp;&nbsp;&nbsp;&nbsp;Contact us</span></td>
										</tr>
										<tr>
											<td>
												<hr />
										...
										<tr>
											<td>
												...
												Email:<br>
												Edwin, Chong Wing CHEUNG : ECheung@umac.mo<br />
												Mayur Divate : mdivate@umac.mo
												<br><br>

												Address:<br>
												Faculty of Health Sciences Building<br />
												University of Macau, E12<br />
												Avenida da Universidade, Taipa, Macau, China<br /><br />
