...
<body>
	...
	<form action="Differential_Significance.php" method="get" id="myForm">
				...
				<td align="left" valign="top" width="250">
					<div id="yuanjiao4" <?php if ($show_intr == 0) {
						...
						<table width="100%">
							<tr>
								<td align="left">
									<span style="color:#333;font-size:18px">&nbsp;&nbsp;&nbsp;&nbsp;Differential Significance</span>
								</td>
							</tr>
							<tr>
								<td>
					...
					<div id="yuanjiao5" <?php if ($show_intr == 1) {
						...
						<table width="100%">
							<tr>
								<td align="left">
									<span style="color:#333;font-size:18px">&nbsp;&nbsp;&nbsp;&nbsp;Differential significance result</span>
								</td>
							</tr>
							<tr>
								<td>
